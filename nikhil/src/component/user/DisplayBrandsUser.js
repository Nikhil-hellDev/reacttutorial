...
function DisplayBrandsUser() {
 const[dbname,setdbname] = React.useState('mob')
...
let body={
        ...
        console.log(body);
       const result=await postData('admin/displayBrandsUser',body)
...
export default DisplayBrandsUser
